...
CREATE TABLE documento_adjunto (
    ...
    CONSTRAINT ck_tamano_maximo   CHECK (tamano_bytes <= 10485760)
);
...
-- Password por defecto: Admin@Clinica2025 — cambiar en primer acceso
